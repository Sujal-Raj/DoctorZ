...
// import { ChevronLeft, ChevronRight, Phone, Video, X } from "lucide-react";
// import { formatDate } from "date-fns";
// import { formatDayShort, formatDateNumber } from "../utils/date";
...
//   function setCurrentMonth(newMonth: Date) {
//     throw new Error("Function not implemented.");
//   }

//   function setSelectedDate(newMonth: Date) {
//     throw new Error("Function not implemented.");
//   }
...
//                     function setSelectedDate(d: any) {
//                       throw new Error("Function not implemented.");
//                     }

//                     function setSelectedTime(arg0: null) {
//                       throw new Error("Function not implemented.");
//                     }
...
//                         function setSelectedTime(time: any): void {
//                           throw new Error("Function not implemented.");
//                         }
...
const BookingDrawer: React.FC<Props> = ({
  ...
  const handleBook = async (formData: {
    ...
    try {
      ...
      data.append(
        "dateTime",
        `${selectedDate.toISOString().slice(0, 10)}T${selectedTime}:00Z`
      );
