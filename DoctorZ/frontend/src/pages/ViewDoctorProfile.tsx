...
const ViewDoctorProfile: React.FC = () => {
  ...
  const faqs = [
    {
      ...
      answer: "Our main healthcare facility in the medical district with state-of-the-art infrastructure."
    },
    {
      question: "How can I book an appointment?",
      answer: "You can book directly through our portal, call our helpline, or visit the clinic in person."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, telemedicine services are available for follow-up consultations and remote patients."
    },
  ];
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="animate-pulse text-gray-600 text-lg">Loading doctor profile...</div>
      </div>
    );
  }
  ...
  if (!doctor) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-red-600 text-lg font-semibold">Doctor profile not found</div>
      </div>
    );
  }
