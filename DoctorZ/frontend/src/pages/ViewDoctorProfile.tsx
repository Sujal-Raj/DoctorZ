...
//     {/* Doctor Card */}
//     <div className="gap-3 p-6 flex flex-col md:flex-row bg-gray-200 rounded-xl shadow">
...
//         <p className="mt-2 text-black">{doctor?.specialization}</p>
//         <p className="text-gray-600">{doctor?.experience} year experience</p>

//         <p className="mt-2 text-gray-900 flex gap-2 items-center">
//           <GraduationCap className="text-gray-600" size={22} />
//           {doctor?.qualification}
//         </p>

//         <p className="mt-2 text-gray-900 flex gap-2 items-center">
//           <MessageCircleMore className="text-gray-600" size={20} />
//           {doctor?.language}
//         </p>
//       </div>
//     </div>
...
//         <h1 className="text-gray-600 mb-2 font-semibold text-lg ml-1">Pick a time Slot</h1>
//       <BookingDrawer
//         doctor={
//           doctor
//             ? {
...
//             <button
//               className="w-full flex justify-between items-center text-left text-sm font-medium hover:text-blue-700"
