...
// const Patients: React.FC = React.memo(() => {
...
//         const formatted = (res.data.labPatients || []).map((b) => ({
//           ...b,
//           userId:
//             b.userId && typeof b.userId === "object"
//               ? b.userId
//               : { _id: "N/A", fullName: "Unknown" },
//           bookingDate: b.bookingDate || null,
//         }));

//         if (mounted) setPatients(formatted);
//       } catch (err) {
//         console.error(err);
...
//         ? new Date(p.bookingDate).toLocaleDateString("en-IN")
//         : "";
//       return name.includes(s) || test.includes(s) || dateStr.includes(s);
//     });
...
//       } p-6 rounded-2xl shadow-lg transition-colors duration-300 max-w-7xl mx-auto`}
//     >
//       {/* Header */}
//       <header className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
//         <div>
//           <h1 className="text-3xl font-bold tracking-tight">Booked Patients</h1>
//           <p
//             className={`mt-1 text-sm ${
//               darkMode ? "text-gray-400" : "text-gray-600"
//             }`}
//           >
//             View all patient bookings — clean, readable, and theme adaptive.
//           </p>
//         </div>
...
//             className={`px-3 py-2 rounded-lg border hover:shadow-sm transition font-medium ${
//               darkMode
...
//             className={`w-full px-4 py-2 rounded-lg border focus:ring-2 focus:ring-blue-400 text-base font-medium transition ${
//               darkMode
...
//                   <tr
//                     key={p._id}
//                     className={`${rowAlt} hover:bg-blue-50 dark:hover:bg-slate-700 transition`}
//                   >
//                     <td className="px-4 py-3 font-medium">
//                       {safeFullName(p.userId)}
//                     </td>
//                     <td className="px-4 py-3">{p.testName || "—"}</td>
//                     <td className="px-4 py-3">{formatDate(p.bookingDate)}</td>
//                   </tr>
//                 );
//               })
//             )}
