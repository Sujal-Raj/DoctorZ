...
//     try {
//       const res = await axios.get<any>(`/api/timeslots/getActiveSlots/${doctorId}`);
...
// setSavedSlots(data as DoctorSlot[]);
...
// const availableDates = savedSlots
//   .filter((slot: DoctorSlot) => slot.slots.some((s) => s.isActive))
//   .map((s) => new Date(s.date));
