        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-white/20">
              ...
              <span className="text-sm font-medium">India's New Healthcare Platform</span>
            </div> */}
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4 leading-tighter">
              Your Health,
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-gray-200 focus:border-[#0c213e] focus:outline-none text-gray-800 text-lg"
                  />
                </div>
                <div className="flex-1 relative">
                ...
                <button className="bg-[#0c213e] hover:bg-[#1a3557] text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 whitespace-nowrap">
